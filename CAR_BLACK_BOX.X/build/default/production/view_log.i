...
# 29 "view_log.c"
    if(key == 1 && ind > 0) ind--;
    else if(key == 2 && ind < (log_num - 1)) ind++;
    else if(key == 12) {
        pind = -1;
        ind = 0;
        state = e_main_menu;
    ...
    if(ind == 9 ) clcd_putch('A', (0xC0 + (0)));
    else clcd_putch((ind + '1'), (0xC0 + (0)));
    ...
    if(ind != pind) {
        ...
        clcd_print(gear, (0xC0 + (2)));
        clcd_print(speed, (0xC0 + (4)));
        clcd_print(time, (0xC0 + (8)));
    }
}
