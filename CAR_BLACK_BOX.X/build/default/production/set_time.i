...
void set_time(void)
{
    ...
    clcd_print(hr_str, (0xC0 + (4)));
    clcd_print(":", (0xC0 + (6)));
    clcd_print(min_str, (0xC0 + (7)));
    clcd_print(":", (0xC0 + (9)));
    clcd_print(sec_str, (0xC0 + (10)));

    if(toggle) {
        if(field == 2) clcd_print("  ",(0xC0 + (10)));
        else if(field == 1) clcd_print("  ",(0xC0 + (7)));
        else if(field == 0) clcd_print("  ",(0xC0 + (4)));
    }
